...
internal static partial class LocalizationStrings
{
    ...
    private static void AddGameHubPortuguese()
    {
        ...
        t["GH_ProfileLabel"] = "Perfil:";
        t["GH_ChooseProfile"] = "Escolher perfil";
        t["GH_EditProfileSettings"] = "Editar as configurações do perfil";
        t["GH_AvgFpsHint"] = "FPS médio que este jogo alcançou nas sessões registradas.";
        t["GH_ContinuePlaying"] = "Continuar jogando";
        t["GH_MostPlayed"] = "Mais jogados";
        t["GH_SeeAll"] = "Ver todos";
        t["GH_PcReady"] = "PC PRONTO";
        t["GH_PcReadyHint"] = "Tudo certo para jogar.";
        t["GH_Tagline"] = "JOGOS FAZEM DIAS MELHORES.";
        t["GH_LibraryTitle"] = "Biblioteca";
        t["GH_Remove"] = "Remover";
    ...
    private static void AddGameHubEnglish()
    {
        ...
        t["GH_ProfileLabel"] = "Profile:";
        t["GH_ChooseProfile"] = "Choose profile";
        t["GH_EditProfileSettings"] = "Edit the profile's settings";
        t["GH_AvgFpsHint"] = "Average FPS this game reached across recorded sessions.";
        t["GH_ContinuePlaying"] = "Continue playing";
        t["GH_MostPlayed"] = "Most played";
        t["GH_SeeAll"] = "See all";
        t["GH_PcReady"] = "PC READY";
        t["GH_PcReadyHint"] = "All set to play.";
        t["GH_Tagline"] = "GAMES MAKE DAYS BETTER.";
        t["GH_LibraryTitle"] = "Library";
        t["GH_Remove"] = "Remove";
